...
int main(int argc, char const *argv[])
{
    ...
    // Person poly("Mr.", "John"); Wont work because this is a pure virtural class

    Person *p1{new Student("A000000007", "Jamie", "Dough", 6.0)};
    Person &p2 = *(new Student("aaa", "bbb", "ccc"));

    // std::cout << poly.speak() << std::endl;
    std::cout << s4.speak() << std::endl;
    std::cout << p1->speak() << std::endl; // still calls on the Person.speak();
